...
spark = SparkSession.builder \
    ...
    .config("spark.jars.packages", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.1.1,com.datastax.spark:spark-cassandra-connector_2.12:3.1.0,com.github.jnr:jnr-posix:3.1.7") \
    .getOrCreate()
...
feature_columns = [
    "International_plan", "Voice_mail_plan", "Number_vmail_messages", "Total_day_minutes", "Total_day_calls",
    "Total_day_charge", "Total_eve_minutes", "Total_eve_charge", "Total_eve_calls", "Total_night_minutes",
...
def predict_data(df_batch, batch_id):
    try:
        ...
        if df_batch.count() > 0:
            ...
            # Print to console
            predictions_to_save.show(truncate=False)
            # Write to Cassandra
